...
Ablak::Ablak(string nev, int szelesseg, int magassag, bool allandomeret, bool szinkronizaltrenderer) {
...
//    ablak létrehozása
    ...
    if(ablakpointer == nullptr) throw std::domain_error("Az " + nev + " ablakot nem sikerült létrehozni! SDL error:" + SDL_GetError());
//    flag-ek beállítása
    eger_rajta = true;
...
//    renderer létrehozása
    ...
    if(renderer == nullptr){
        ...
        throw std::domain_error("A renderert nem sikerült létrehozni! SDL error: " + string (SDL_GetError()));
    }
